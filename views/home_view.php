    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
            ...
            <form action="" method="POST" class="mx-auto d-flex px-4 form-group">
                <input type="text" class="form-control form-control-dark text-bg-dark text-center fs-4"
                    placeholder="https://www.youtube.com/watch?v=dQw4w9WgXcQ"
                    aria-label="https://www.youtube.com/watch?v=dQw4w9WgXcQ" name="url" id="url">
                <input type="submit" class="btn btn-lg btn-secondary text-black fw-bold border-white bg-white ms-3"
                    value="Short URL">
            </form>

            <form enctype="multipart/form-data" class=" mx-auto px-4 mt-4" action="controllers/upload.php"
                method="post">
            ...
            <section class="alert alert-success mt-4 border rounded d-flex flex-column px-4 justify-content-center"
                role="alert">
                ...
                <img width="150" height="150"
                    src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?= urlencode($newShortUrl) ?>"
